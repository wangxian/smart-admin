import { getDownloadAxios, postAxios } from '@/lib/http';
...
export const fileApi = {
  ...
  fileUploadLocalUrl: baseUrl + '/api/file/localUpload/', // 上传路径：阿里OSS
  fileUploadAliUrl: baseUrl + '/api/file/aliYunUpload/', // 上传路径：七牛

...
<script>
  ...
  export default {
    ...
    data () {
      ...
      return {
        // loading
        isShowSaveButtonLoading: false, // 上传
        upload: {
          uploadList: [],
          data: {
            type: 'NEWS_PIC'
    ...
    methods: {
      ...
      initEditor () {
        ...
        g.editor.customConfig = {
          ...
          showLinkImg: false,
          uploadImgShowBase64: false, // 上传路径
          uploadImgServer: g.baseUrl + fileApi.fileUploadUrl + '1', // 上传文件名key
          uploadFileName: 'file', // 参数
          uploadImgParams: {

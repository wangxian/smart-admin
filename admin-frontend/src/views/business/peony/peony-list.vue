      ...
      <Row class="smart-query-form-row">
        ...
        <ButtonGroup>
          <Button
            ...
            icon="ios-search"
            type="primary"
            v-privilege="'peony-list-query'">查询
          </Button>
          <Button
      ...
      <Row class="smart-query-form-row" v-show="showMoreQueryConditionFlag">
        ...
        <span>
          ...
          <DatePicker
            ...
            style="width: 200px"
            type="daterange"
            v-model="queryForm.createdAtRange"></DatePicker>
        </span>
        <span>
          更新时间:
          <DatePicker
            ...
            style="width: 200px"
            type="daterange"
            v-model="queryForm.updatedAtRange"></DatePicker>
        </span>
      </Row>
      <!------ 查询条件第二行 end------->
    </Card>
  ...
  export default {
    ...
    data () {
      return {
        ...
        mainTableSelectArray: [], /* -------------------------导出操作------------------------- */
        // 批量导出loading按钮
        batchExportBtnLoading: false, // 导出全部loading按钮
        allExportBtnLoading: false, /* -------------------------查询条件相关数据-------------------- */
        // 搜索表单
        queryForm: {
          // ID
          id: null, // 品种
    ...
    methods: {
      ...
      async batchDelete () {
        this.$Spin.show();
        await peonyApi.batchDeletePeony(this.mainTableSelectArray.map(e => e.id));

  ...
  export default {
    ...
    data () {
      ...
      return {
        // 数据量
        total: null, // 文件表格加载
        tableLoading: false, // 查询参数
        searchForm: {
          pageNum: 1,
          pageSize: 10, // 是否查询总条数
          searchCount: true,
          fileName: null, // 业务类型 BACK_USER:1 backUser/config
          moduleType: 1, // 文件位置 LOCAL:1 本地文件服务 ALI_OSS:2 阿里OSS文件服务 QI_NIU_OSS:3七牛文件服务
        ...
        columns: [{
          ...
          render (h, params) {
            return h('span', {}, that.getFileLocationTypeDesc(params.row.fileLocationType));
          }
        }, {
          title: '文件名称',
          key: 'fileName'
    ...
    methods: {
      ...
      async uploadSuccess (e) {
        ...
        let reqBody = {
          ...
          fileLocationType: this.searchForm.fileLocationType ? this.searchForm.fileLocationType: 1,

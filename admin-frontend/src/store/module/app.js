import { getBreadCrumbList, getHomeRoute, getNextRoute, getRouteTitleHandled, getTagNavListFromLocalStorage, routeEqual, routeHasExist, setTagNavListInLocalStorage } from '@/lib/menu-func';
...
export default {
  state: {
    // 缓存路由
    keepAliveIncludes: [], // 面包屑列表
    breadCrumbList: [], // tag列表
    tagNavList: [], // 首页路由
    homeRoute: {}, // 本地缓存
    local: localRead('local'), // 错误列表
    errorList: [],
